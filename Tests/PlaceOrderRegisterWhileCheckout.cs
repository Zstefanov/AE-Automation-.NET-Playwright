...
{
    public class PlaceOrderRegisterWhileCheckout : TestFixtureBase
    {
        ...
        //end-to-end test -> quite long
        [Test]
        public async Task Place_Order_Register_While_Checkout()
        {
            await NavigateToUrl();
            ...
            //await Page.Locator("input[data-qa='pay-button']").ClickAsync();
